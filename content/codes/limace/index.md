...
![Malkus modes](https://fgerick.github.io/Limace.jl/dev/examples/malkusmodes/0acbb336.png "Malkus mode computed Limace.jl following [the example in the documentation](https://fgerick.github.io/Limace.jl/dev/examples/malkusmodes/).")
